...
def test_tabula_version(language, version_output):
    ...
    output = client.containers.run("illumidesk/tabula:latest", f"{language} --version")
...
def test_invalid_cmd():
    ...
    with pytest.raises(ContainerError):
        ...
        client = docker.from_env()
        client.containers.run("illumidesk/tabula", "foo --version")
